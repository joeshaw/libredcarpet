			...
			add {
				if (value.Method.GetCustomAttributes(typeof(GLib.ConnectBeforeAttribute), false).Length > 0) {
					if (BeforeHandlers["changed_channels"] == null)
						BeforeSignals["changed_channels"] = new RCSharp.voidObjectSignal(this, "changed_channels", value, typeof (System.EventArgs), 0);					else
					...
					if (AfterHandlers["changed_channels"] == null)
						AfterSignals["changed_channels"] = new RCSharp.voidObjectSignal(this, "changed_channels", value, typeof (System.EventArgs), 1);					else
			...
			add {
				if (value.Method.GetCustomAttributes(typeof(GLib.ConnectBeforeAttribute), false).Length > 0) {
					if (BeforeHandlers["changed_subscriptions"] == null)
						BeforeSignals["changed_subscriptions"] = new RCSharp.voidObjectSignal(this, "changed_subscriptions", value, typeof (System.EventArgs), 0);					else
					...
					if (AfterHandlers["changed_subscriptions"] == null)
						AfterSignals["changed_subscriptions"] = new RCSharp.voidObjectSignal(this, "changed_subscriptions", value, typeof (System.EventArgs), 1);					else
			...
			add {
				if (value.Method.GetCustomAttributes(typeof(GLib.ConnectBeforeAttribute), false).Length > 0) {
					if (BeforeHandlers["changed_locks"] == null)
						BeforeSignals["changed_locks"] = new RCSharp.voidObjectSignal(this, "changed_locks", value, typeof (System.EventArgs), 0);					else
					...
					if (AfterHandlers["changed_locks"] == null)
						AfterSignals["changed_locks"] = new RCSharp.voidObjectSignal(this, "changed_locks", value, typeof (System.EventArgs), 1);					else
			...
			add {
				if (value.Method.GetCustomAttributes(typeof(GLib.ConnectBeforeAttribute), false).Length > 0) {
					if (BeforeHandlers["changed_packages"] == null)
						BeforeSignals["changed_packages"] = new RCSharp.voidObjectSignal(this, "changed_packages", value, typeof (System.EventArgs), 0);					else
					...
					if (AfterHandlers["changed_packages"] == null)
						AfterSignals["changed_packages"] = new RCSharp.voidObjectSignal(this, "changed_packages", value, typeof (System.EventArgs), 1);					else
			...
			add {
				if (value.Method.GetCustomAttributes(typeof(GLib.ConnectBeforeAttribute), false).Length > 0) {
					if (BeforeHandlers["refreshed"] == null)
						BeforeSignals["refreshed"] = new RCSharp.voidObjectSignal(this, "refreshed", value, typeof (System.EventArgs), 0);					else
					...
					if (AfterHandlers["refreshed"] == null)
						AfterSignals["refreshed"] = new RCSharp.voidObjectSignal(this, "refreshed", value, typeof (System.EventArgs), 1);					else
