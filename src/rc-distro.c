...
RCDistroType distro_types[] = {
    ...
    { "solaris-7-sun4u", NULL, "Sun Solaris 7", "7", RC_PKG_RPM, RC_ARCH_SPARC, "" },
    { "solaris-8-sun4u", NULL, "Sun Solaris 8", "8", RC_PKG_RPM, RC_ARCH_SPARC, "" },
