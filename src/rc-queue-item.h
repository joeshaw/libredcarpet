...
void         rc_queue_item_uninstall_set_due_to_conflict (RCQueueItem *item);
void         rc_queue_item_uninstall_set_due_to_obsolete (RCQueueItem *item);
