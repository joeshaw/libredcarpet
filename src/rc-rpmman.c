 ...
 */
#define LATEST_SUPPORTED_RPM_VERSION 40202
...
load_fake_syms (RCRpmman *rpmman)
{
     ...
     * going on */
#if RPM_VERSION >= 40100 && RPM_VERSION <= 40202 /* RPM 4.1 to 4.2.2 inclusive */
    /* FIXME: untested */
    ...
    if (rpmman->version >= 40004) {
        ...
        if (rpmman->version == 40004) { /* RPM 4.0.4 only */
            ...
            rpmman->headerLoad = *(*hdrfuncs + 9);
                 ...
                 rpmman->version <= 40202) { /* RPM 4.1-4.2.2 inclusive */
    ...
    /* Now, write out each of the objects */
    {
        ...
        ObjectInfo objects[] = {
            ...
            { "rc-{rpm_rpmio_rpmdb}-4.1-popt.so.1.so",
              rc_rpm_rpmio_rpmdb_4_1_popt_so_1_so,
              rc_rpm_rpmio_rpmdb_4_1_popt_so_1_so_len },
            { "rc-{rpm_rpmio_rpmdb}-4.1-popt.so.0.so",
              rc_rpm_rpmio_rpmdb_4_1_popt_so_0_so,
              rc_rpm_rpmio_rpmdb_4_1_popt_so_0_so_len },
